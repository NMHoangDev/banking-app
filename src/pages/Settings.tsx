  ...
  const tabs = [
    {
      ...
      label: "Cài đặt chung",
      icon: Globe,
      desc: "Thông tin cơ bản của hệ thống",
    },
    {
      id: "security",
      label: "Bảo mật & Truy cập",
      icon: Shield,
      desc: "Kiểm soát đăng nhập và phiên",
    },
    {
      id: "notifications",
      label: "Thông báo",
      icon: Bell,
      desc: "Cấu hình kênh truyền thông",
    },
    {
      id: "appearance",
      label: "Giao diện",
      icon: Layout,
      desc: "Chủ đề và cách hiển thị",
    },
    {
      id: "api",
      label: "API & Tích hợp",
      icon: Database,
      desc: "Kết nối bên thứ ba",
    },
  ];
  ...
  useEffect(() => {
    ...
    getSettings()
      ...
      .catch((err) => {
        ...
        setSettingsError("Không thể tải cấu hình, sử dụng mặc định.");
      })
      .finally(() => {
        ...
        <div className="lg:col-span-3 space-y-2">
                ...
                <div>
                  ...
                  <p
                    className={cn(
                      ...
                      activeTab === tab.id ? "text-white" : "text-outline",
                    )}
                  >
                    {tab.desc}
                  </p>
          ...
          <div className="p-5 bg-tertiary-container rounded-2xl text-white relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <p className="text-[11px] text-primary-fixed-dim leading-relaxed mb-4">
                Mọi thay đổi quan trọng sẽ được lưu lại trong nhật ký sự kiện.
              </p>
          ...
          <div className="bg-white border border-outline-variant rounded-2xl p-6 md:p-8 shadow-sm">
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      defaultValue="Enterprise Bank Global"
                      className="w-full bg-surface border border-outline-variant rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-primary font-bold text-primary shadow-sm"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-outline uppercase tracking-widest pl-1">
                ...
                <div className="pt-6 border-t border-dashed border-outline-variant">
                  <h4 className="text-sm font-bold text-primary mb-6 flex items-center gap-2">
                    ...
                    Thông tin mạng lưới kỹ thuật
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold text-outline uppercase tracking-widest pl-1">
                        Địa chỉ máy chủ Core
                      </label>
                      <input
                        type="text"
                        defaultValue="internal.bank.core.enterprise"
                        className="w-full bg-surface border border-outline-variant rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-primary font-medium opacity-70"
                        readOnly
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <input
                        type="text"
                        defaultValue="10.224.x.x / 172.16.x.x"
                        className="w-full bg-surface border border-outline-variant rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-primary font-medium opacity-70"
                        readOnly
                      />
                    </div>
            ...
            {activeTab === "security" && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                  ...
                  {[
                    {
                      ...
                      desc: "Bắt buộc đối với tất cả tài khoản quản trị viên và giao dịch trên 500tr.",
                      active: true,
                    },
                    {
                      title: "Tự động đăng xuất",
                      desc: "Phiên làm việc sẽ kết thúc sau 15 phút không có hoạt động.",
                      active: true,
                    },
                    {
                      title: "Giới hạn đăng nhập IP",
                      desc: "Chỉ cho phép truy cập từ dải mạng nội bộ hoặc VPN công ty.",
                      active: false,
                    },
                    {
                      title: "Mã hóa nhật ký truy cập",
                      desc: "Tất cả hành động người dùng sẽ được mã hóa chuẩn AES-256.",
                      active: true,
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between p-5 bg-surface border border-outline-variant rounded-2xl hover:border-primary/30 transition-all group"
                    >
                      <div className="flex items-start gap-4">
                        <div
                          className={cn(
                            "p-2 rounded-xl mt-1 shadow-sm",
                            item.active
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-on-surface-variant mt-0.5 leading-relaxed pr-8">
                            {item.desc}
                          </p>
                        </div>
                      </div>
                ...
                <div className="pt-6 border-t border-dashed border-outline-variant">
                  <h4 className="text-sm font-bold text-primary mb-6 flex items-center gap-2">
                    <div className="w-1 h-3 bg-primary rounded-full"></div> Kiểm
                    soát mật khẩu
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        type="number"
                        defaultValue="12"
                        className="w-full bg-surface border border-outline-variant rounded-xl px-4 py-3 text-sm focus:outline-none font-bold text-primary shadow-sm"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold text-outline uppercase tracking-widest pl-1">
                        Thời hạn thay đổi (Ngày)
                      </label>
                      <input
                        type="number"
                        defaultValue="90"
            ...
            {activeTab === "notifications" && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300 text-center py-10">
                ...
                <p className="text-sm text-on-surface-variant max-w-[400px] mx-auto italic">
                  Tính năng quan trọng dành cho liên lạc và báo động hệ thống.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10 text-left">
                  {[
                    ...
                    "Tin nhắn SMS (OTP)",
                    "Thông báo nội bộ (Push)",
                    "Webhook đối tác",
                  ].map((n) => (
                    <div
                      key={n}
                      className="p-4 bg-white border border-outline-variant rounded-2xl flex items-center gap-4 hover:shadow-md transition-all"
                    >
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
                <div className="p-6 bg-surface border-2 border-dashed border-primary/20 rounded-3xl relative overflow-hidden group">
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-bold text-outline flex items-center gap-1 uppercase tracking-widest">
                          <Shield className="w-3 h-3" /> Cấp độ bảo mật: Cao
                          nhất
                        </p>
                      </div>
                    </div>
                    ...
                    <p className="text-[10px] text-on-surface-variant mt-4 italic font-medium leading-relaxed">
                      Sử dụng khóa này để xác thực trong các yêu cầu API từ dịch
                      vụ đối tác. Không chia sẻ khoá này qua các kênh trò chuyện
                      công khai.
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white border border-outline-variant rounded-2xl overflow-hidden divide-y divide-outline-variant/30">
                    {[
                      ...
                      {
                        method: "POST",
                        endpoint: "/v1/transfers/internal",
                        time: "12p trước",
                        status: "201 CREATED",
                        color: "text-secondary",
                      },
            ...
            <div className="mt-12 flex flex-col sm:flex-row justify-end gap-3 pt-8 border-t border-outline-variant">
              <button className="px-8 py-3 rounded-xl text-sm font-bold text-on-surface-variant hover:bg-surface-container-low transition-all">
                Cài đặt mặc định
              </button>
              <button
                onClick={handleSave}
                className="px-10 py-3 rounded-xl text-sm font-bold bg-primary text-white shadow-xl hover:shadow-primary/20 hover:-translate-y-0.5 transition-all active:translate-y-0"
              >
                Cập nhật cấu hình
              </button>
            </div>
